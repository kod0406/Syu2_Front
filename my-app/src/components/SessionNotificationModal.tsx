    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full z-[9999]">
            <div className="bg-black bg-opacity-50 w-full h-full flex items-center justify-center animate-fade-in">
                <div className={`bg-white rounded-xl max-w-lg min-w-80 mx-5 shadow-2xl animate-slide-up overflow-hidden border-l-4 ${config.borderColor} sm:mx-4 sm:min-w-auto sm:max-w-[calc(100%-32px)]`}>
