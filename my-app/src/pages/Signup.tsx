    ...
    <div className="flex items-center justify-center min-h-screen bg-green-100">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">새로운 계정을 만들어 서비스를 시작하세요</p>
        </div>

        <form onSubmit={handleSignup} className="space-y-5">
          {/* 이메일 입력 */}
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-700 block">이메일 주소</label>
            <input
                type="email"
          ...
          {/* 가게 이름 입력 */}
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-700 block">가게 이름</label>
            <input
                type="text"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-green-600 mb-2">회원가입 완료!</h3>
