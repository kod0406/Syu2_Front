  ...
  const verifyEmail = async (token: string) => {
    try {
      ...
      if (err.response?.status === 400) {
        ...
        setMessage('인증 링크가 만료되었습니다. 새로운 인증 메일을 요청해주세요.');
      ...
      <div className="w-full max-w-lg bg-white p-8 rounded-2xl shadow-2xl">
        {status === 'loading' && (
          <div className="text-center">
            ...
            <h1 className="text-2xl font-semibold text-gray-800 mb-3">이메일 인증 처리 중...</h1>
            <p className="text-gray-600">잠시만 기다려주세요. 인증을 완료하고 있습니다.</p>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="text-center">
            ...
            <p className="text-lg text-gray-700 mb-2 font-medium">이메일 인증이 성공적으로 완료되었습니다!</p>
            <p className="text-gray-600 mb-8">이제 IGO 매장 관리 시스템의 모든 기능을 이용하실 수 있습니다.</p>

            <div className="bg-blue-50 p-6 rounded-xl mb-8">
              <h3 className="text-lg font-semibold text-blue-800 mb-3">🚀 이제 다음 기능들을 사용할 수 있어요!</h3>
        ...
        {status === 'error' && (
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-red-600 mb-3">❌ 인증 실패</h1>
