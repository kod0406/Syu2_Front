      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-sm mx-2 p-6 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="border-t pt-4 mt-4">
            <p className="text-sm text-gray-600 mb-3">비밀번호 변경 (선택사항)</p>
              ...
              <div className="relative">
                ...
                >
                  {showPassword.current ? (
                    ...
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.293-3.95m3.36-2.676A9.956 9.956 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.956 9.956 0 01-4.043 5.306M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="text-center mb-4">
            <h3 className="text-sm font-medium text-gray-900 mb-2">위험 구역</h3>
